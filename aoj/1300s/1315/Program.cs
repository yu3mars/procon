                    ...
                    else    //out
                    {
                        ...
                        if(id =="000")  //if god out
                        {
                            foreach (var al in alter)
                            {
                                if(al.Value == true)
                                {
                                    time[id] += Math.Min((dt - enterTime[al.Key]).TotalMinutes, (dt - enterTime["000"]).TotalMinutes);
                                    /*
                                    if (enterTime["000"].CompareTo(enterTime[al.Key])<0) //god enter earlier
                                    {
                                        time[al.Key] += (dt - enterTime[al.Key]).TotalMinutes;
                                    }
                                    else
                                    {
                                        time[al.Key] += (dt - enterTime["000"]).TotalMinutes;
                                    }
                                    */
                                }
                            }
