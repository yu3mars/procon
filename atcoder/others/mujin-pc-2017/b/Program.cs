    ...
    class Problem : IDisposable
    {
        ...
        void SolveOne()
        {
            ...
            for (int tate = 0; tate < n; tate++)
            {
                ...
                yokoMax = Math.Max(yokoMax, yokoTmp);
            }
            for (int yoko = 0; yoko < n; yoko++)
            {
                int tateTmp = 0;
            ...
            if (yokoMax == n) // include n==1
            {
                Console.WriteLine(n - tateFull);
                return;
            }
            // 1retsu sorotte nai
            if (n == 2)
            ...
            else if (n == 3)
            {
                ...
                for (int tate = 0; tate < n; tate++)
                {
                    if (s[tate][tate] == '#')
                    {
                        ...
                        int tateTmp = 0;
                        for (int tateTmpCnt = 0; tateTmpCnt < n; tateTmpCnt++)
                        {
                            if (s[tateTmpCnt][tate] == '#')
                            {
                                tateTmp++;
                            }
                        }
            ...
            else //ippan
            {
                ...
                if (taikakuYokoMax>1)
                {
                    if (yoko0Full)
                    {
                        Console.WriteLine(n * 2 - taikakuYokoMax - 1);
                    }
                    else
                    {
                        Console.WriteLine(n * 2 - taikakuYokoMax);
                    }
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine(n * 2 + 1 - yokoMax);
                    }
                }
                return;
            }
