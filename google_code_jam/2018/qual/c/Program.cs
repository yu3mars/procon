        ...
        void SolveOne()
        {
            ...
            for (int ii = 1; ii <= t; ii++)
            {
                ...
                for(;;)
                {
                    ...
                    Console.WriteLine("2 {0}",nowy);
                    string[] s = Console.ReadLine().Split(' ');
                    int xPreapred = int.Parse(s[0]);
                    int yPrepared = int.Parse(s[1]);
                    if (xPreapred==0 && yPrepared==0)
                    {
                        break;
                    }
                    map[xPreapred, yPrepared] = true;
